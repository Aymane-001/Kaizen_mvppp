...
function getLeaderboard(period = 'today', limit = 50) {
  const field = period === 'today' ? 'xp_daily'
    ...
    : 'xp_total';
  return [...users.values()]
    .map(u => { resetPeriodsIfNeeded(u); return {
...
const DAILY_POOL = [
  ...
  { id: 'total60',   title: 'earn 600 xp today',                       reward: 25, type: 'total_xp' },
  { id: 'total150',  title: 'earn 1500 xp today',                      reward: 60, type: 'total_xp' },
  { id: 'total300',  title: 'earn 3000 xp today',                      reward: 120, type: 'total_xp' },
  { id: 'solo25',    title: 'finish a full 25min solo commit',       reward: 40, type: 'solo' },
  { id: 'solo50',    title: 'finish a full 50min solo commit',       reward: 90, type: 'solo' },
